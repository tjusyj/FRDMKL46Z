...
int main (void)
{
  ...
  for(;;)
  {
        ...
        printf("\n\r*********************** USB device demo code  ***************\n");
        
        printf("\n\r connect KL46 USB to PC,  wait for enumeration, USB is configured as CDC device (COM port)");
        printf("\n\r write any character into the terminal and it will be echoed ");
