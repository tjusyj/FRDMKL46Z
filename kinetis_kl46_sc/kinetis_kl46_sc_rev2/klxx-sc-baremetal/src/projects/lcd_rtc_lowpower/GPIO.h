...
#define LED1_PORT   A   // Green LED
#define LED1_BIT    17

#define LED2_PORT   B    // Red LED
#define LED2_BIT    8

#define LED3_PORT     E    // Oranage LED
#define LED3_BIT    26

//#define LED3_PORT   A    // Oranage LED       TWR-KL46Z REV B
//#define LED3_BIT    5

#define LED4_PORT   A    // Yellow LED
#define LED4_BIT    16
